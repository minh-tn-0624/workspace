...
class reactive_follow_gap:
    ...
    def lidar_callback(self, data):
        ...
        closest_point_idex, closest_distance = self.find_closest_point(ranges)
        # print ("closest point idex = " + str(closest_point_idex))

        #Eliminate all points inside 'bubble' (set them to zero) 
        ranges_with_bubble = self.set_safety_bubble(ranges, closest_point_idex, closest_distance)
        ...
        best_point_idx = self.find_best_point(ranges, start_index, end_index)
